...
var renderPage = function(url) {
  ...
  var isReady = function () {
    return page.evaluate(function () {
      ...
      if (typeof Package === 'undefined'
          || Package["4scotty:spiderable-longer-timeout"] === undefined
          || Package["4scotty:spiderable-longer-timeout"].Spiderable === undefined
          || !Package["4scotty:spiderable-longer-timeout"].Spiderable._initialSubscriptionsStarted ) {
        return false;
      }
  ...
  var dumpPageContent = function () {
    ...
    if(output.indexOf('<!-- response:status-code=404 -->') > -1) {
      status = 404;
    }
  ...
  page.open(url, function(status) {
    ...
    intervalId = setInterval(function() {
      ...
      if(renderIterations < 50 && (!renderStatus || status === null || status == 'null')){
